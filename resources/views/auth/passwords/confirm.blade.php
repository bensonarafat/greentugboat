...
<div class="md:container md:mx-auto mt-5 mb-5 flex justify-center">
    <div class="flex-col flex">
        ...
        <form class="w-full max-w-lg border pb-4 pt-2 px-3 rounded mb-5" method="POST" action="{{ route('password.confirm') }}">
            @csrf
            <div class="text-center pb-4 pt-4">
                <h1 class="font-black text-[#1d8861] text-2xl uppercase">Confirm Password </h1>
            </div>
            ...
            <div class="flex flex-wrap -mx-3 mb-6 pl-5 pr-5">
                <button type="submit" class="btn bg-[#1d8861] w-full  py-2.5"><strong class="uppercase text-white">Confirm Password</strong></button>
            </div>
