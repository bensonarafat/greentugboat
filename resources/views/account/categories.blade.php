                                    ...
                                    <tbody>
                                        @foreach ($categories as $row)
                                            <tr>
                                                ...
                                                <td>
                                                    @if(getPermission("editCategory")) <a href="" class="btn btn-primary btn-sm js_edit_category" data-toggle="modal" data-target="#editCategory" data-id="{{ $row->id }}">Edit</a> @endif
                                                    @if(getPermission("deleteCategory"))  <a href="{{ route("delete.category", $row->id) }}" class="btn btn-danger btn-sm">Delete</a> @endif
                                                </td>
                                            </tr>
