...
@section("title", "New Post -" . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="display: flex;justify-content:space-between">
          <h4 class="tx-gray-800 mg-b-5">New Post</h4>
        </div>
        ...
        <div class="br-pagebody">
            ...
            <div class="br-section-wrapper" style="padding: 30px 20px;">
                <form method="POST" name="" action="{{ route("store.post") }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-9">
