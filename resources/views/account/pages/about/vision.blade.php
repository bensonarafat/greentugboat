...
@section("title", "Vision - " . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
        ...
        <div class="br-section-wrapper">
            <div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route("update.about.vision") }}" method="post" enctype="multipart/form-data">
                            @csrf
