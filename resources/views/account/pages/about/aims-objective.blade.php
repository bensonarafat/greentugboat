...
@section("title", "Aims and Objectives - " . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
...
<div class="br-mainpanel">
    <div class="br-pageheader pd-y-15 pd-l-20 ">
        <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Aims and Objectives</span>
        </nav>
    </div><!-- br-pageheader -->
    <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="display: flex;justify-content:space-between">
        <h4 class="tx-gray-800 mg-b-5">Aims and Objectives</h4>
    </div>
        ...
        <div class="br-section-wrapper">
            <div id="accordion" class="accordion" role="tablist" aria-multiselectable="true">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route("update.about.aims.objective") }}" method="post" enctype="multipart/form-data">
                            @csrf
