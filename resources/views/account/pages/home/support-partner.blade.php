...
@section("title", "Support Partner -" . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20 ">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <span class="breadcrumb-item active">Support Partner</span>
          </nav>

        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="display: flex;justify-content:space-between">
          <h4 class="tx-gray-800 mg-b-5">Support Partner</h4>
        </div>
        <div class="br-pagebody">
            ...
            @include("layouts.dashboard.alert")
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="{{ route("support.partner.store") }}" enctype="multipart/form-data">
                                    @csrf
          ...
          <div id="editModel" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center" role="document">
                <form action="{{ route("support.partner.update") }}" method="POST" enctype="multipart/form-data">
        ...
        $(document).ready(function(){
            ...
            $('body').on("click", '.js_edit', function(e){
                ...
                data.append('id', id);
                $.ajax({
                    url: BASE_URL + '/account/pages/home/support-partner/edit/' + id,
                    method: "GET",
                    timeout: 5000,
                    data: data,
                    contentType: false,
