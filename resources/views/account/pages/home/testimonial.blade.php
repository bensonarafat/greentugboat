...
@section("title", "Affimations -" . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form method="post" action="{{ route("testimonial.store") }}" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        <label for="image">Image (61 X 60)</label>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route("delete.testimonial", $row->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>
          ...
          <script>
            ...
            $(document).ready(function(){
                ...
                $('body').on("click", '.js_edit', function(e){
                    ...
                    data.append('id', id);
                    $.ajax({
                        url: BASE_URL + '/account/pages/home/testimonial/edit/' + id,
                        method: "GET",
                        timeout: 5000,
                        data: data,
                        contentType: false,
