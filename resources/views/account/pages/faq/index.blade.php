...
@section("title", "FAQs -" . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
    ...
    <div class="br-mainpanel">
        ...
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="display: flex;justify-content:space-between">
          <h4 class="tx-gray-800 mg-b-5">FAQs</h4>
        </div>
                            ...
                            <div class="card-body">
                                <form action="{{ route("store.faq") }}" method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" name="sort" id="sort" value="1" class="form-control">
                                    </div>
                                    <div class="form-group">
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <a href="{{ route("delete.page.faq", $row->id) }}" class="btn btn-danger btn-sm">Delete</a>
                                                    </td>
                                                </tr>
          ...
          <script>
            $(document).ready(function(){
                ...
                $('body').on("click", '.js_edit', function(e){
                    ...
                    data.append('id', id);
                    $.ajax({
                        url: BASE_URL + '/account/pages/faq/edit/' + id,
                        method: "GET",
                        timeout: 5000,
                        data: data,
                        contentType: false,
