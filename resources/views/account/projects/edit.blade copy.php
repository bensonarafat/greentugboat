                    ...
                    <div id="wizard7">
                        ...
                        <section>
                            <div style="display:flex;justify-content: center; padding-bottom:20px;">
                                <h4>Enter project budget</h4>
                            </div>
                            <div style="display:flex;justify-content: center;">
                                <h1 style="font-size:80px;">@php echo naira() @endphp</h1>
                                <input type="text" name="budget" id="budgetinput" class="budgetinput" value="{{ $project->budget }}" pattern="[0-9]*" onkeypress="return event.charCode >= 48 && event.charCode <= 57" onpaste="return false">
                            </div>
                        </section>
                        <h3>Categories</h3>
                        <section>
