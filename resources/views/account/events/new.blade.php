...
@section("title", "New Event -" . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
    ...
    <div class="br-mainpanel">
        ...
        <div class="br-pagebody">
            ...
            <div class="br-section-wrapper" style="padding: 30px 20px;">
                <form method="POST" name="" action="{{ route("store.event") }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-9">
                        ...
                        <div class="col-sm-3">
                            ...
                            <div class="form-layout-footer">
                                <button name="submit" class="btn btn-info" style="width: 100%" style="cursor: pointer">Publish</button>
                            </div>
                        </div>
                    </div>
