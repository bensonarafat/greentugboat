...
@section("title", "Donations -" . Auth::user()->firstname . ' '. Auth::user()->lastname)
@section("content")
    ...
    <div class="br-mainpanel">
        <div class="br-pageheader pd-y-15 pd-l-20 ">
          <nav class="breadcrumb pd-0 mg-0 tx-12">
            ...
            <a class="breadcrumb-item" href="{{ route("manage.projects") }}">Donations</a>
            <span class="breadcrumb-item active">Manage Donations</span>
          </nav>
        </div><!-- br-pageheader -->
        <div class="pd-x-20 pd-sm-x-30 pd-t-20 pd-sm-t-30" style="display: flex;justify-content:space-between">
          <h4 class="tx-gray-800 mg-b-5">Manage Donations</h4>
